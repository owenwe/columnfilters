...
/**
 * Template for content section of the control.
 * template variable:
 *     {
 *         panelheading.filterFactory (View.el),
 *         panelheading.filterColumns (Array)
 *     }
 * @memberof $.fn.ColumnFilters
 * @constant {string} DATA_FILTERS_PANEL_CONTENT_TEMPLATE
 */
$.fn.ColumnFilters.DATA_FILTERS_PANEL_CONTENT_TEMPLATE = [
