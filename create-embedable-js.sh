...
cat media/js/columnfilters/baseClasses/filterTypes/date/dateBefore.js >> columnfilters-embedable.js && printf "\n\n" >> columnfilters-embedable.js
cat media/js/columnfilters/baseClasses/filterTypes/date/dateAfter.js >> columnfilters-embedable.js && printf "\n\n" >> columnfilters-embedable.js
