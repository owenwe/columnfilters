...
/*	'			<ul class="nav navbar-nav">'+
	...
	'			</ul>'+
*/	
	'<% if(controller.filterCategories.length){ print(\'<ul class=\"nav navbar-nav navbar-right\"><li class=\"btn btn-xs disabled\" title=\"delete\"><a href=\"#\" class=\" btn btn-xs\"><span class=\"glyphicon glyphicon-remove\"></span> </a></li><li class=\"dropup btn btn-xs cf-save-filter-list\" title=\"save\"><a href=\"#\" class=\"dropdown-toggle btn btn-xs\" data-toggle=\"dropdown\"><span class=\"glyphicon glyphicon-floppy-disk\"></span><span class=\"caret\"></span></a><ul class=\"dropdown-menu\" role=\"menu\"></ul></li></ul>\'); } %>'+
	'		</div>'+
	'	</div>'+
'</nav>';
